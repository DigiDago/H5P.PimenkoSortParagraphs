...
import PimenkoSortParagraphsContent from './h5p-sort-paragraphs-content';
import Util from './h5p-sort-paragraphs-util';

/**
 * Main class.
 */
export default class PimenkoSortParagraphs extends H5P.Question {
  /**
   * @constructor
  ...
  getTitle() {
    ...
    raw = raw || PimenkoSortParagraphs.DEFAULT_DESCRIPTION;
   ...
   */
  getDescription() {
    return this.params.taskDescription || PimenkoSortParagraphs.DEFAULT_DESCRIPTION;
  }
