...
import PimenkoSortParagraphsParagraph from './h5p-sort-paragraphs-paragraph';
import PimenkoSortParagraphsSeparator from './h5p-sort-paragraphs-separator';

/** Class representing the content */
export default class PimenkoSortParagraphsContent {
  /**
   * @constructor
  ...
  constructor(params = {}, callbacks = {}) {
    ...
    params.paragraphs.forEach((paragraph, index) => {
      ...
      this.separators.push(new PimenkoSortParagraphsSeparator());
    });
   ...
   * @param {PimenkoSortParagraphsParagraph[]|PimenkoSortParagraphsSeparator[]} elements Elements.
  ...
  /**
   * Build list of paragraphs.
   * @param {PimenkoSortParagraphsParagraph[]} paragraphs Paragraphs.
   ...
   * @return {PimenkoSortParagraphsParagraph} Paragraph.
   */
  buildParagraph(text) {
